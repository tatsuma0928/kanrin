      ...
      this.jKanban = function () {
        ...
        arguments[0] && "object" == _typeof(arguments[0]) && (this.options = function (e, t) {
          ...
          !function () {
            ...
            void 0 !== o.dragTo && -1 === o.dragTo.indexOf(t.parentNode.dataset.id) && t.parentNode.dataset.id !== n.parentNode.dataset.id && b.drake.cancel(!0), null !== e && (!1 === b.options.dropEl(e, t, n, i) && b.drake.cancel(!0), e.classList.remove("is-moving"), "function" == typeof e.dropfn && e.dropfn(e, t, n, i));
          }));
        }, this.enableAllBoards = function () {
          var e = document.querySelectorAll(".kanban-board");
          if (0 < e.length && void 0 !== e) for (var t = 0; t < e.length; t++) {
          ...
          return "string" == typeof e && (e = b.element.querySelector('[data-eid="' + e + '"]')), null !== e && ("function" == typeof e.remove ? e.remove() : e.parentNode.removeChild(e)), b;
        }, this.removeBoard = function (e) {
          var t = null;
          "string" == typeof e && (t = b.element.querySelector('[data-id="' + e + '"]')), null !== t && ("function" == typeof t.remove ? t.remove() : t.parentNode.removeChild(t));
  ...
  5: [function (n, i, e) {
    (function (o) {
      ...
      var r = n("custom-event"),
          a = n("./eventmap"),
          c = o.document,
          e = function e(_e, t, n, i) {
        return _e.addEventListener(t, n, i);
      },
          t = function t(e, _t, n, i) {
        return e.removeEventListener(_t, n, i);
      },
          d = [];
      ...
      o.addEventListener || (e = function e(_e2, t, n) {
        ...
        var i = s(e, _t2, n);
        if (i) return e.detachEvent("on" + _t2, i);
      }), i.exports = {
        add: e,
        remove: t,
    ...
    (function (o) {
      ...
      function z(e, t, n) {
        var i,
            o = e || {},
            r = o.className;
        return o.className += " gu-hide", i = j.elementFromPoint(t, n), o.className = r, i;
      }
      ...
      t.exports = function (e, t) {
        ...
        function f(e) {
          if (c) if (0 !== U(e)) {
            if (void 0 === e.clientX || e.clientX !== r || void 0 === e.clientY || e.clientY !== a) {
              ...
              h = ee("pageX", e) - o.left, g = ee("pageY", e) - o.top, Y.add(w || m, "gu-transit"), function () {
                if (p) return;
        ...
        function k(e) {
          if (!(C.dragging && p || d(e))) {
            ...
            var n = J(e);
            if (n) if (!T.invalid(e, t)) if (T.moves(e, n, t, Z(e))) return {
              item: e,
              source: n
            };
          }
        ...
        function O(e) {
          if (L(), C.dragging) {
            var t = w || m,
                ...
                i = ee("clientY", e),
                o = H(z(p, n, i), n, i);
            o && (w && T.copySortSource || !w || o !== v) ? B(t, o) : T.removeOnSpill ? I() : N();
          }
        }
        ...
        function N(e) {
          if (C.dragging) {
            var t = 0 < arguments.length ? e : T.revertOnSpill,
                ...
                i = J(n),
                o = A(i);
            !1 === o && t && (w ? i && i.removeChild(w) : v.insertBefore(n, b)), o || t ? C.emit("cancel", n, v, v) : C.emit("drop", n, i, v, y), _();
          }
        }
          ...
          if (p) {
            ...
            if (c !== v || !w || T.copySortSource) {
              ...
              if (null !== l) u = D(c, l, t, n);else {
                if (!0 !== T.revertOnSpill || w) return void (w && s && s.removeChild(r));
                u = b, c = v;
              }
              (null === u && d || u !== r && u !== Z(r)) && (y = u, c.insertBefore(r, u), C.emit("shadow", r, c, v));
        ...
        function D(o, t, r, a) {
          ...
          return t !== o ? function () {
            ...
            for (e = 0; e < i; e++) {
              if (t = o.children[e], n = t.getBoundingClientRect(), c && n.left + n.width / 2 > r) return t;
...
/***/ 2:
/*!*******************************************!*\
  !*** multi ./resources/js/jkanban.min.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/kanrin/resources/js/jkanban.min.js */"./resources/js/jkanban.min.js");
